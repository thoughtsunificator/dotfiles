...
To report a bug please use [this link](https://github.com/thoughtsunificator/dotfiles/issues/new?assignees=&labels=&projects=&template=BUG_REPORT.md&title=).
...
To suggest an idea please use [this link](https://github.com/thoughtsunificator/dotfiles/issues/new?assignees=&labels=&projects=&template=FEATURE_REQUEST.md&title=).
