...
- [@web/test-runner](https://github.com/modernweb-dev/web) (e2e testing)
- [stryker](https://github.com/stryker-mutator/stryker-js) (mutation testing)
...
As the guidelines are enforced by tools such as [Knip](https://github.com/webpro-nl/knip), [eslint](https://github.com/eslint/eslint) and [stylelint](https://github.com/stylelint/stylelint), for the most part you can easily verify that your work is compliant (in terms of style) using `npm run lint`.
